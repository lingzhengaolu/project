...
//
//import com.company.dataprocessing.DataUploadToMysql;
...
////		loginPage.wait(40);
////		loginPage.quit();
//		DataUploadToMysql dataUploadToMysql=new DataUploadToMysql(connection);
//		dataUploadToMysql.uploadElenemt();
//		dataUploadToMysql.uploadCase();
//
//		sqlConnection.close();
//
//
